...
CACHE_POLICY = 'M_Cache' #'DM_Cache' #'PERFECT_LFU' #'RAND' #'FIFO' #'LRU'   

# Zipf alpha parameter, remove parameters not needed
#ALPHA = [0.6, 0.8, 1.0] ## Default
...
#NETWORK_CACHE = [0.004, 0.002] #Default
NETWORK_CACHE = [0.04, 0.08, 0.12, 0.16, 0.2] 
#NETWORK_CACHE = [0.08] ##Testing
